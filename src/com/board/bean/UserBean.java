...
public class UserBean {
	...
	// 출력을 쉽게 하기 위해 toString 메소드 생성. 
	// toString은 Object클래스에 정의되어있는 메소드이다. 모든 클래스는 보이지 않지만 Object클래스를 상속하고 있다.
	@Override
	public String toString() {
		return "UserBean [user_id=" + user_id + ", user_pw=" + user_pw + ", user_name=" + user_name + ", user_birth="
				+ user_birth + ", user_phone=" + user_phone + ", user_email=" + user_email + ", user_zip=" + user_zip
				+ ", user_addr=" + user_addr + ", user_gender=" + user_gender + ", select_p=" + select_p
				+ ", rcv_agree=" + rcv_agree + "]";
	}
}
