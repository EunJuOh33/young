...
<body>
	...
	<div id="container">
		<div class="wideContent">
			...
			<div class="contents">
			 	<div class="mylevel">
			 		<img src="img/rion.png" class="i" alt="" />
			 		<p class="hello" style='font-weight:600;'>
			 			환영합니다! <span style='color: #A6CD48;'>${user_id }</span> 님이 로그인 하셨습니다.
			 		</p>
			 	</div>
		 		<div class="wishList">
			 		...
			 		<div class="myPrd">
						...
						<c:if test="${wishList != null && id == user_id}">
							<ul class="wish_Prd">
				 				<c:forEach var="wish" items="${wishList }"  varStatus="status">
								<li class="wish_prd">
					 				<img src="img/${wish.wish_image}" alt="-"/>
					 				<p class="opt_prdname">${wish.wish_name }</p>
					 				<p class="cost">${wish.wish_price }</p>
					 			</li>
				 				</c:forEach>	
				 			</ul>
			 			</c:if>
